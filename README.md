...
Baixe o [instalador offline](micro_radar_ais_v1.00_instalador.zip), extraia e execute `gravar.bat`.
...
| `micro_radar_ais_v1.00_instalador.zip` | Instalador offline com `esptool.exe` e `gravar.bat` |
...
*Firmware v1.00. O código-fonte é mantido em um repositório privado.*
